...
create server comagic foreign data wrapper plexor options (
    node_0 'dbname=comagic0 host=127.0.0.1 port=5432',
    node_1 'dbname=comagic1 host=127.0.0.1 port=5432',
